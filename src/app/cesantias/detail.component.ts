...
@Component({
             selector: 'app-cesantiasdetail',
             templateUrl: './detail.component.html',
             styleUrls: ['./detail.component.css']
           })
export class CesantiasdetailComponent implements OnInit {
  ...
  constructor(public renderer2: Renderer2,
    ...
    this.breadcrumbService.setItems([
      { label: 'Cesantias', routerLink: ['/cesantias'] },
      { label: 'Detalle' }]);
  }
  ...
  ngOnInit() {
    this.route.params.subscribe((params: Params) => {
      ...
      if (this.id) {
        this.tirillasService.getByIdCesantias(this.id)
        .subscribe(data => {
          this.data = data[0];
